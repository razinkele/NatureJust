    ...
    output$download_report <- downloadHandler(
      ...
      content = function(file) {
        ...
        html <- paste0(
          ...
          "<p><strong>Intervention:</strong> ", htmltools::htmlEscape(input$intervention), "</p>",
          "<p><strong>Target Area:</strong> ", htmltools::htmlEscape(area), "</p>",
          "<p><strong>Regional Context:</strong> ", htmltools::htmlEscape(context), "</p>",
          ...
          paste0(
            "<tr><td>", htmltools::htmlEscape(df$dimension), "</td>",
            "<td>", round(df$score * 100), "%</td>",
            "<td class='", df$status, "'>",
            vapply(df$status, status_to_label, ""),
            "</td>",
            "<td>", htmltools::htmlEscape(df$description), "</td></tr>",
            collapse = ""
          ),
          "</table>",
          gap_html,
